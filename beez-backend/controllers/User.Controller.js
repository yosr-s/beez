...
const UserController = {
            ...
            if (err) { 
                ...
                if (userInfo != undefined)
                    if (bcrypt.compareSync(req.body.password, userInfo.password)) {
                        ...
                        tokenList[refresh_token]=refresh_token
    ...
    logout: function (req, res) {
        ...
        console.log(req.body.refresh_token ,req.body.refresh_token in tokenList)
        if (req.body.refresh_token && req.body.refresh_token in tokenList) {
            ...
            res.status(401).json({ status: "err", message: "refresh token not found!!!", data: null });
        }
    },
